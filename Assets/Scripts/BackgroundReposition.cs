...
public class BackgroundReposition : MonoBehaviour
{
    ...
    public int columns = 13;         // 가로 개수 (9x9 이므로 9)
    public float spacingX = 2.15f;   // 가로 간격
    public float spacingY = 2.15f;
    ...
    public void sorting()
    {
        ...
        for (int i = 0; i < children.Count; i++)
        {
            ...
            children[i].localPosition = new Vector3(posX - 11.5f, posY + 11.5f, 0);
        }
    }
}
